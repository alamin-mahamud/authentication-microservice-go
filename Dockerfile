...
WORKDIR /go/src/github.com/alamin-mahamud/authentication-microservice-go
...
COPY --from=builder /go/src/github.com/alamin-mahamud/authentication-microservice-go/auth .
